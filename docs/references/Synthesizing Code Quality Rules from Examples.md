...
- Paper: [DOI](https://dl.acm.org/doi/10.1145/3563350)
- Talk: [youtube](https://www.youtube.com/watch?v=Y_BdglTnxHU)

## Abstract

Static Analysis tools have rules for several code quality issues and these
...
than 30 Java code quality rules. These rules have been deployed as part of
Amazon CodeGuru Reviewer and their precision exceeds 75% based on developer
feedback collected during live code-reviews within Amazon. Through comparisons
with recent baselines, we show that current state-of-the-art program synthesis
