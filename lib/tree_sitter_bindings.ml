...
external parser_set_language : nativeint -> nativeint -> bool = "ts_helper_parser_set_language"
external parse_to_sexp : nativeint -> string -> string = "ts_helper_parse_to_sexp"
